...
namespace RememberBreakDownItem
{
    internal class Patches
    {
        ...
        [HarmonyPatch(typeof(Panel_BreakDown), nameof(Panel_BreakDown.Update), new Type[0])]
        ...
        [HarmonyPatch(typeof(Panel_BreakDown), nameof(Panel_BreakDown.OnBreakDown), new Type[0])]
        ...
        private static void Use(Panel_BreakDown panel, int toolInstanceID)
        {
            ...
            Il2CppSystem.Collections.Generic.List<GearItem> tools = panel.m_Tools;
